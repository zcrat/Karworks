...
<main class="main vaniflex vanigrow">
    <div class="container-fluid vaniflex vanigrow">
            <div class="card vanigrow">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i>Folios de Presupuestosy
                    ...
                    @if ($estatus == 4 || $estatus == 6)
                        <button class="btn btn-primary" id="Verprefacturas">Ver Prefacturas</button>
                    @endif
                </div>
    ...
    @include('modales.AproobacionConceptos')
