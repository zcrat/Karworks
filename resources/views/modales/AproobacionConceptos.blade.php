     ...
     window.eliminarconcepto = function(idconcepto) {
        ...
        function actualizarlista(){
            ...
            $.each(listaconceptos, function(index, element) {
                ...
                //row.append('<td><div class="Datatable-content">' + (element.venta ? element.venta : 0 ) + '</div></td>');
        ...
        $(document).on('change','.preciodiagnostico,.preciodiagnosticofinal, .cantidaddiagnostico', function () {
                ...
                if (itemIndex !== -1) {
                    ...
                    const cantidad = parseFloat(listaconceptos[itemIndex].Cantidad) || 0;
                    const venta = parseFloat(listaconceptos[itemIndex].Venta) || 0;
                    const subtotal = cantidad * venta;

                    $('label.subtotaldiagnostico[data-id="' + id + '"]').text(
