            ...
            <form method="post" id="formnewrecepcion">
                ...
                <div class="modal-body">
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                        <div class=" selectconlabel zdmg-r02"><label for="ord_seguimiento">Ord.
                                seguimiento<strong>*</strong></label><input required class="form-control" type="text"
                                placeholder="Ej.100A " id="ord_seguimiento" name="ord_seguimiento">
                        </div>
                        <div class="selectconlabel zdmg-r02"><label for="folio">Id<strong></strong></label><input
                                class="form-control" type="text" placeholder="Ej. 100ABC " id="folio"
                                name="folio">
                        </div>
                        <div class="selectconlabel zdmg-r02"><label for="fecha">Fecha<strong>*</strong></label><input
                                id="fecha" name="fecha" class="form-control" required type="datetime-local"
                                class="custom-datetime-icon-input form-control">
                        </div>
                    </div>
                    <h4>Datos Cliente</h4>
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                        <div class="select2conlabel zdw-45pct  zdrelative">
                            ...
                            <div><select id="empresasrecepcion" name="empresasrecepcion"></select>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w zdrelative">
                        <div class="vaniwidth">
                            <div class="select2conlabel"><label for="">Vehiculo <span class="spanrelleno">
                                        #Econonomico- Placas</span><strong>*</strong></label><select required
                                    id="vehiculo" name="vehiculo"></select>
                                <button class="btnin" id="newcar"type="button">+</button>
                            </div>
                        </div>
                        <div class="selectconlabel"><label for="kmentrada">Km Entrada <strong>*</strong></label><input
                                required class="form-control" type="number" name="kmentrada" id="kmentrada">
                        </div>
                        <div class="selectconlabel"><label for="kmsalida">Km Salida<strong>*</strong></label><input
                                required class="form-control" type="number" name="kmsalida" id="kmsalida">
                        </div>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between canvasconlabel">
                        ...
                        <select required name="tipo_auto" id="tipo_auto" class="form-control">
                            ...
                            <option value="2">Subirban</option>
                        </select>
                        <canvas id="miCanvas" required name="miCanvasmiCanvas"
                            class="form-control canvasdetalles"></canvas>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                        <div class="zdw-60pct">
                            <div class="canvasconlabel">
                                ...
                                <canvas required id="canvasfirma" name="canvasfirma"
                        ...
                        <div class="col-12 col-lg-6 zdw-35pct">
                            ...
                            <div class="selectconlabel zdmgy-r10">
                                ...
                                <input required id="fecha_entrega" name="fecha_entrega" type="datetime-local"
                                    class="custom-datetime-icon-input form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w zdfd-column">
                        <div class="form-control zdmgy-r10">
                            ...
                            <div class="subdivicion vaniflex zdfw-w">
                                <div class="selectconlabel "><label for="puerta_interior_frontal">Izquierda
                                ...
                                <div class="selectconlabel "><label for="puerta_interior_trasera">Izquierda
                                        Trasera<strong>*</strong></label><select required
                                        name="puerta_interior_trasera" id="puerta_interior_trasera"
                                        class="condiciones "></select>
                                </div>
                                <div class="selectconlabel "><label for="puerta_delantera_frontal">Derecha
                                        Frontal<strong>*</strong></label><select required
                                        name="puerta_delantera_frontal" id="puerta_delantera_frontal"
                                        class="condiciones "></select>
                                </div>
                                <div class="selectconlabel "><label for="puerta_delantera_trasera">Derecha
                                        Trasera<strong>*</strong></label><select required
                        ...
                        <div class="subdivicion vaniflex  form-control zdmgy-r10 zdfw-w">
                            ...
                            <div class="selectconlabel "><label for="claxon">Claxon<strong>*</strong></label><select
                                    required name="claxon" id="claxon" class="condiciones "></select>
                            </div>
                            ...
                            <div class="selectconlabel "><label for="toldo">Toldo<strong>*</strong></label><select
                                    required name="toldo" id="toldo" class="condiciones "></select>
                            </div>
                            ...
                            <div class="selectconlabel "><label for="radio">Radio<strong>*</strong></label><select
                                    required name="radio" id="radio" class="condiciones "></select>
                            </div>
                    ...
                    <div class="vaniflex zdmg-r05  zdjc-between zdfw-w">
                        ...
                        <div class="selectconlabel"><label for="estribos">Estribos<strong>*</strong></label><select
                                required name="estribos" id="estribos" class="condiciones "></select>
                        </div>
                        <div class="selectconlabel"><label
                        ...
                        <div class="selectconlabel"><label for="antena_cb">Antena/C.B<strong>*</strong></label><select
                                required name="antena_cb" id="antena_cb" class="condiciones "></select>
                        </div>
                        <div class="selectconlabel"><label
                    ...
                    <div class="vaniflex zdmg-r05  form-control zdjc-between zdfw-w ">
                        ...
                        <div class="textareaconlabel"><label for="indicacionescliente">Indicaciones del
                                Cliente</label>
                    ...
                    <div class="vaniflex zdmg-r05 zform-control zdjc-between zdfw-w zd2col">
                        <div class="selectconlabel"><label for="admintrasportes">Administrador de
                                Trasportes</label><input class="form-control" id="admintrasporte" name=""
                                type="text" placeholder="Ej. Juan Rodriguez">
                        </div>
                        <div class="selectconlabel"><label for="jefedelproceso">Jefe de Proceso</label><input
                                class="form-control" id="jefedelproceso" name="jefedelproceso" type="text"
                                placeholder="Ej.  Jose Leyva">
                        </div>
                        <div class="selectconlabel"><label for="telefonorecepcion">Telefono</label><input
                        ...
                        <div class="selectconlabel"><label for="Trabajador">Trabajador</label><input
                                class="form-control" id="Trabajador" name="Trabajador" type="text"
                                placeholder="Ej.Jesus Ivan ">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(function() {
            ...
            function editaruinputsrecepcion(element) {
                ...
                $("#empresasrecepcion").append('<option value="' + element.empresa_id + '">' + element.empresa
                    .nombre + '</option>');
                $("#vehiculo").append('<option value="' + element.vehiculo.id + '">' + element.vehiculo
                    .no_economico + '-' + element.vehiculo.placas + '</option>');
                $("#clientesrecepcion").append('<option value="' + element.customer.id + '">' + element.customer
                    .nombre + '</option>');
                ...
                for (let field in textFields) {
                    $(`#${textFields[field]}`).val(element[
                        field]); // Usar element[field] para obtener el valor correcto
                }
                ...
                exterioresEquipoFields.forEach(field => {
                    $(`#${field}`).val(element.exteriores[
                        field]); // Asignar el valor correspondiente de element
                });

                // Asignar los valores a los campos de InterioresEquipo
                interioresEquipoFields.forEach(field => {
                    $(`#${field}`).val(element.interiores[
                        field]); // Asignar el valor correspondiente de element
                });
            ...
            $("#formnewrecepcion").submit(function(e) {
                ...
                let data = form.serialize() + '&miCanvas=' + encodeURIComponent(canvasImage) +
                    ...
                    @json($modulo) + '&contrato=' + @json($contrato);
                if (ideditar) {
