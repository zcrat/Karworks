    ...
    <div class="modal-dialog zdmw-95pct modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close ConSheModalClose" aria-label="Close">
                </button>
            </div>
                    ...
                    <div id="ConSheDivTabla" class="TablaConceptos">
                        ...
                        <table id="ConSheTable" class="table table-sm table-striped">
                            <thead>
                                <tr>
                                    <th class='zdw-r1'>#</th>
                                    <th class='zdw-r2'>FECHA</th>
                                    <th class='zdw-r2'>REP</th>
                                    <th class='zdw-r2'>REMP</th>
                                    <th class='zdw-r4'>CLAVE</th>
                                    <th>DESCRIPCION</th>
                                    <th class='zdw-r1'>IVA INC</th>
                                    <th class='zdw-r3'>PARTES C/U</th>
                                    <th class='zdw-r3'>MANO O. C/U</th>
                                    <th class='zdw-r3'>SUB CONTR. C/U</th>
                                    <th class='zdw-r3'>OTROS C/U</th>
                                    <th class='zdw-r4'>SUBTOTAL</th>
                                    <th class='zdw-r2'>UTI %</th>
                                    <th class='zdw-r3'>VENTA C/U</th>
                                    <th class='zdw-r1'></th>
                                </tr>
                            </thead>
                            <tbody>
