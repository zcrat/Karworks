    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id='OpcionesSalida' class='zdflex zdjc-between zdmgb-r10'>
                    </div>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                        ...
                        <div class=" selectconlabel zdmg-r02">
                            <label for="ord_opcional">Orden Opcional</label>
                            <input class="form-control" type="text" placeholder="Ej.1023482 " id="ord_opcional" name="ord_opcional">
                        </div>
                        <div class="selectconlabel zdmg-r02">
                            <label for="ubicacion">Ubicacion</label><input class="form-control" type="text" placeholder="Ej. Norte" id="ubicacion" name="ubicacion">
                        </div>
                         @if (in_array(Auth::user()->id,[1,170,171,192,36]))
                         <div class="select2conlabel zdw-45pct  zdrelative zdhidden">
                            <label for="">Taller</label>
                            <div>
                                <select id="taller_recepcion" name="taller_recepcion" class="talleres_select2"></select>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                        ...
                        <div class="select2conlabel zdw-45pct  zdrelative">
                            <label for="">Cliente/Zona/Usuario <strong>*</strong></label>
                            <select id="clientesrecepcion"name="clientesrecepcion" required></select>
                            <button id="newcustomer"class="btnin NewCustomer" data-select2='clientesrecepcion' type="button">+</button>
                        </div>
                        <div class=" selectconlabel zdmg-r02">
                            <label for="contacto">Contacto</label>
                            <input class="form-control" type="text" placeholder="Ej.Juan Perez " id="contacto" 
                            name="contacto">
                        </div>
                        <div class="selectconlabel zdmg-r05">
                            <label for="contacto_tel">Contacto Telefono</label>
                            <input
                                class="form-control" id="contacto_tel" name="contacto_tel" maxlength="10"
                                pattern="\d{10}" type="tel" placeholder="Ej. 4443552266 ">
                            </div>
                    </div>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w zdrelative">
                        ...
                        <div class="select2conlabel zdw-45pct zdcambiartamanio zdrelative">
                                ...
                                <button class="btnin PreBtnNewOption NewVehiculoTaller" data-select2='vehiculo' id="newcar" type="button" >+</button>
                                <button class="btnin EditVehiculoTaller" id="editcar" data-select2='vehiculo' type="button" hidden><i aria-hidden="true" class="fa fa-pencil-square-o"></i></button>
                            </div>
                    ...
                    <div class="vaniflex zdmg-r05 zform-control zdjc-between zdfw-w zd2col">
                        <div class="select2conlabel zdw-45pct  zdrelative">
                            ...
                            <button data-origin="UserTaller1" data-label="Nombre" data-select2='admintrasportedemo' data-title="Nuevo Administrador de Trasportes" class="btnin NewElementOneAttribute PreBtnNewOption" type="button">+</button>
                        </div>
                        <div class="select2conlabel zdw-45pct  zdrelative">
                            <label for="Tecnico">Tecnico <strong>*</strong></label>
                            <select id="Tecnico"name="Tecnico" required></select>
                            <button data-origin="UserTaller4" data-label="Nombre" data-select2='Tecnico' data-title="Nuevo Tecnico" class="btnin NewElementOneAttribute PreBtnNewOption" type="button">+</button>
                        </div>
                        <div class="select2conlabel zdw-45pct  zdrelative">
                            ...
                            <button data-origin="UserTaller2" data-label="Nombre" data-select2='jefedelprocesodemo' data-title="Nuevo Jefe de Proceso" class="btnin NewElementOneAttribute PreBtnNewOption" type="button">+</button>
                        </div>
                        
                        <div class="select2conlabel zdw-45pct  zdrelative">
                            <label for="Trabajador">Trabajador<strong>*</strong></label></label>
                            <select id="Trabajadordemo"name="Trabajador" required></select>
                            <button data-origin="UserTaller3" data-label="Nombre" data-select2='Trabajadordemo' data-title="Nuevo Trabajador" class="btnin NewElementOneAttribute PreBtnNewOption" type="button">+</button>
                        </div>
                    </div>
                    ...
                    <div class="vaniflex zdmg-r05 zdjc-between zdfw-w zdfd-column">
                        <div class="form-control zdmgy-r10">
                            ...
                            <div class="subdivicion vaniflex zdfw-w">
                                <div class="selectconlabel "><label for="puerta_interior_frontal">Izquierdo
                                ...
                                <div class="selectconlabel "><label for="puerta_interior_trasera">Izquierd0
                                        Trasera<strong>*</strong></label><select required 
                                        name="puerta_interior_trasera" id="puerta_interior_trasera"
                                        class="condiciones "></select>
                                </div>
                                <div class="selectconlabel "><label for="puerta_delantera_frontal">Derecho
                                        Frontal<strong>*</strong></label><select required 
                                        name="puerta_delantera_frontal" id="puerta_delantera_frontal"
                                        class="condiciones "></select>
                                </div>
                                <div class="selectconlabel "><label for="puerta_delantera_trasera">Derecho
                                        Trasera<strong>*</strong></label><select required 
                        ...
                        <div class="form-control zdmgy-r10">
                            <h6>Asientos</h6>
                            <div class="subdivicion vaniflex  zdfw-w">
                                <div class="selectconlabel "><label for="asiento_interior_frontal">Izquierdo
                                        Frontal<strong>*</strong></label><select required 
                                        name="asiento_interior_frontal" id="asiento_interior_frontal"
                                        class="condiciones "></select>
                                </div>
                                <div class="selectconlabel "><label for="asiento_interior_trasera">Izquierdo
                                        Trasera<strong>*</strong></label><select required 
                                        name="asiento_interior_trasera" id="asiento_interior_trasera"
                                        class="condiciones "></select>
                                </div>
                                <div class="selectconlabel "><label for="asiento_delantera_frontal">Derecho
                                        Frontal<strong>*</strong></label><select required 
                                        name="asiento_delantera_frontal" id="asiento_delantera_frontal"
                                        class="condiciones "></select>
                                </div>
                                <div class="selectconlabel "><label for="asiento_delantera_trasera">Derecho
                                        Trasera<strong>*</strong></label><select required 
                    ...
                    <div class="vaniflex zdmg-r05  form-control zdjc-between zdfw-w ">
                        ...
                        <div class="textareaconlabel"><label for="indicacionescliente">Reporte de Fallas</label>
...
@push('scripts')
    <script>
        ...
        if(fol){
            ...
            let idcar = $(this).val()
             if(idcar){
                $("#newcar").attr('hidden',true)
                $("#editcar").removeAttr('hidden').data('id',idcar)
             }else{
                $("#newcar").removeAttr('hidden')
                $("#editcar").attr('hidden',true).removeData('id')
             }
            })
            ...
            function editarrecepcion(id) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        BotonesActualizacion(response.recepcion.detalles_generales)
            ...
            function editaruinputsrecepcion(element) {
                ...
                $("#newcar").attr('hidden',true)
                $("#editcar").removeAttr('hidden').data('id',element.detalles_generales.vehiculo.id)
                $('.zdcambiartamanio').removeClass('zdw-45pct').addClass('zdw-90pct');
                $("#empresasrecepcion").empty().append('<option value="' + element.detalles_generales.empresa.id + '">' + element.detalles_generales.empresa.nombre + '</option>');
                $("#vehiculo").empty().append('<option value="' + element.detalles_generales.vehiculo.id + '">' + element.detalles_generales.vehiculo.no_economico + '-' + element.detalles_generales.vehiculo.placas + '</option>');
                $("#clientesrecepcion").empty().append('<option value="' + element.detalles_generales.Customer_id + '">' + element.detalles_generales.customer.nombre + '</option>');
                $("#admintrasportedemo").empty().append('<option value="' + element.detalles_generales.administrador_trasporte.id + '">' + element.detalles_generales.administrador_trasporte.nombre + '</option>');
                $("#Tecnico").empty().append('<option value="' + element.tecnico.id + '">' + element.tecnico.nombre+'</option>');
                $("#jefedelprocesodemo").empty().append('<option value="' + element.detalles_generales.jefede_proceso.id + '">' + element.detalles_generales.jefede_proceso.nombre + '</option>');
                $("#Trabajadordemo").empty().append('<option value="' + element.detalles_generales.trabajador.id + '">' + element.detalles_generales.trabajador.nombre + '</option>');
            ...
            function limpiarmodalrecepcion() {
                ...
                arrayfiles=[];
                ideditar="";
                const taller=@json(Auth::user()->taller_id);
                const userid=@json(Auth::user()->id);
                console.log(userid)
                $("#fotosevidencia").empty();
                $("#OpcionesSalida").empty().attr('hidden',true) ;
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    BotonesActualizacion(response.element)
                                },
                                error: function(xhr, status, error) {
                                if (xhr.status === 422) {
                                        errors = error.responseJSON.errors;
                                        message='Errores de validación:<br>';
                                        Object.keys(erroresindes).forEach(key => {
                                        });
           ...
           $(document).on('click', '#PedidoEntregado', function() {
            ...
            $(document).on('click', '#Fecha_salida', function() {
                 Swal.fire({
                        icon: "question",
                        text: "¿Estás seguro de guardar la salida del vehiculo?",
                        showCancelButton: true,
                        confirmButtonText: "Confirmar",
                        cancelButtonText: "Cancelar",
                        reverseButtons: true,
                ...
                $.ajax({
                    type: 'post',
                    url: '{{ route('Detalles.Generales.Register.Salida') }}',
                    data: {
                        _token: "{{ csrf_token() }}",
                        DetGenId: $(this).attr('idordenservicio'),
                        DetGenGasSal: $('#gassalida').val(),
                        DetGenKilSal:  $('#kmsalida').val(),
                    },
                    success: function(response) {
                        mostramensajeexito(response.message||'Registrado')
                        BotonesActualizacion(response.element)
