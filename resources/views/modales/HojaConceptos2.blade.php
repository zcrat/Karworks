        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <div class="HojaConceptosCaptura verrsionhc2">
                    ...
                    <div class="Visorizquierda" id='div1' style="width:100%">
                    ...
                    <div class="Visorderecha" id='div2'  style="width:100%" >
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="toggleview" >Ver Pdf</button>
