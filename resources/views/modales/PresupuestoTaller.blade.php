    ...
    <div class="modal-dialog zdmw-95pct modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="PresupuestoTitle">Editar Presupuesto Taller</h5>
                     ...
                     <form id="ButgetForm">
                        ...
                        <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                            <div class=" select2conlabel zdw-20pct  zdrelative">
                                <label for="PreOrdSer">Ord.servicio</label>
                                <div class="iconoin">
                            ...
                            <div class="zdw-45pct vaniflex zdfd-column">
                                <label for="PreIndCli">Indicaciones Cliente</label>
                                <textarea class="zdh-100pct form-control" name="PreIndCli" id="PreIndCli"></textarea>
                            </div>
                            <div class="zdw-45pct vaniflex zdfd-column">
                                <label for="PreDesMO">Descripcion Mano Obra</label>
                        ...
                        <div class="vaniflex zdmg-r05 zdjc-between zdfw-w">
                            ...
                            <div class=" selectconlabel zdmg-r02">
                                ...
                                <input required class="form-control" type="text" disabled id="PreVehMod">
                            </div>
                            <div class=" selectconlabel zdmg-r02">
                                <label for="PreVehVim">VIM</label>
                                <input  class="form-control" type="text" disabled id="PreVehVim">
                            </div>
                            <div class=" selectconlabel zdmg-r02">
                                <label for="PreVehPla">Placas</label>
                                <input  class="form-control" type="text" disabled id="PreVehPla">
                            </div>
                            <div class=" selectconlabel zdmg-r02">
                                <label for="PreVehAnio">Año</label>
                                <input  class="form-control" type="text" disabled id="PreVehAnio">
                            </div>
                            <div class=" selectconlabel zdmg-r02">
                                <label for="PreVehMar">Marca</label>
                                <input  class="form-control" type="text" disabled id="PreVehMar">
                            </div>
                        </div>
                    </form>
                    <div id="PreTablaCon">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="PreUpdCon">Actualizar Conceptos</button>
    ...
    $(function(){
     ...
     window.eliminarconcepto = function(idconcepto) {
        ...
        function llenar_campos(element){
            ...
            IdsInputsHidden=['ButgetButtonCreate']
            IdsInputsNotDisabled=['PreFol','PreDesMO','PreId']
            ...
            $('#DetGenEdit').attr('data-id',element.DetallesGenerales_id);
        ...
        function OpenModalNew(){
            ...
            IdsInputsNotHidden=['ButgetButtonCreate','PreSer','PreVehTip']
        ...
        function PreFound(){
            ...
            IdsInputsNotDisableds=['PreFol','PreSer','PreDesMO']
        ...
        function actualizarlista(){
            ...
            $.each(listaconceptos, function(index, element) {
                ...
                row.append('<td><label data-id="' + element.id + '" class="subtotaldiagnostico ">' + Number((element.Cantidad * element.Costo)).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + '</label></td>');
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        error: function (error) {
                            Swal.fire({
                                icon:'error',
                                title:'Ocurrio un problema al Actualizar El Presupuesto',
                                showConfirmButton: false,
                                timer: 1000,
                            });
                        }
