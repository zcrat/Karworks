...
<head>
    ...
    <title>Reporte de Recepción de Vehículo2</title>
...
<body>
    @foreach ($RecepcionesVehiculares as $indice)
        @foreach ($indice['RecepcionVehicular'] as $c)
            <div class="  ggg">
                <div class="titulo">
                    <h5 class="cent titulo-principal">Reporte de Recepción de Vehículo</h5>
                </div>
                <div class="iden">
                    <h6 class="titulo__folio">No: <span class="text--rojo ">{{ $c->folioNum }}</span></h6>
                </div>
                <div class="completo col-md- "> <!--contenedor 1-->
                    <div class="bloque__uno  "> <!--blouqe__uno 1-->
                        ...
                        <div class=" uno-bor "><label for="text">Gas. Entrada</label> <label for="text"><span
                                    class="table--text">
                        ...
                        <div class=" uno-bor "><label for="text">Gas. Salida</label> <label for="text"><span
                                    class="table--text">
                        ...
                        <div class=" uno-bor  u4 level--2"><label for="text">KM Entrada</label> <label
                                for="text"><span class="table--text">{{ $c->km_entrada }}</span></label></div>
                        <div class=" uno-bor level--2 "><label for="text">KM Salida</label> <label
                                for="text"><span class="table--text">{{ $c->km_salida }}</span></label></div>
                ...
                <div class="bloque___dos    bord "> <!--ID-->
                    ...
                    <div class=" di"><label for="text">Firma de Supervisión</label>
                        ...
                        <img src="{{ asset('img/firmas/' . $c->firma . '') }}" width="100%" height="50px" />
                ...
                @foreach ($indice['InterioresEquipo'] as $i)
                    <div class="interiores"> <!--interiores-->
                        ...
                        <div class="bor"> <!--borde ifs-->
                            <div class="contenedor-ifs"> <!--IFS-->
                                ...
                                <div>
                                    <p class="text-right">Paneles de Puertas</p>
                                </div>
                            ...
                            <div class="similares ">
                                ...
                                <div class="text-right"><label class="level-1  " for="text">Consola
                                        Central</label></div>
                                ...
                                <div class="text-right"><label class=" " for="text">Luces Interiores</label>
                                </div>
                                ...
                                <div class="text-right"><label class=" " for="text">Seguros
                                ...
                                <div class="text-right"><label class=" " for="text">A.C./Climatizador
                                    </label></div>
                                ...
                                <div class="text-right"><label class="" for="text">Espejo
                                        Retrovisor</label></div>
                                <div class="bb">
                                    <?php
            ...
            @foreach ($indice['ExterioresEquipo'] as $e)
            ...
            @foreach ($indice['EquipoInventario'] as $ei)
                <div class="bloque-varios "> <!--  varios-->
                    <div>
                        <h6 class="titulo-principal">Varios Equipos - Inventario</h6>
                    </div>
                    <div class="g-3">
                        <div>
                            <p>SI </p>
                        ...
                        <div>
                            <p>Llave para Tuercas de Rueda</p>
                        </div>
                        <div class="cuadrado">
            ...
            @foreach ($indice['Seguro'] as $s)
                <div class="bloque__seguro bord">
                    <!--<div class="col-md-12"><label for="text">FOLIO</label> <label for="text">resultado</label></div>-->
                    <div class="col-md-12 fg"></div>
                    <div class="col-md-12 fg">
                        <label for="text">Cía. Seg.</label>
                        <label for="text">
                            {{ $s->cia_seg }}
                        </label>
                    </div>
                    <div class="col-md-12 fg">
                        <label for="text">Tel. Seg.</label>
                        <label for="text">
                            {{ $s->tel_seg }}
                        </label>
                    </div>
                    <div class="col-md-12 fg">
                        <label for="text">Siniestro No.</label>
                        <label for="text">
                            {{ $s->no_siniestro }}
                        </label>
                    </div>
                    <div class="col-md-12 di">
                        <label for="text">Ajustador</label>
                        <label for="text">
                            {{ $s->ajustador }}
                        </label>
                    </div>
            ...
            @foreach ($indice['condicionesPintura'] as $cp)
                <div class="level--2">
                    <h6 class="titulo-principal">Condiciones de Pintura</h6>
                </div>
            ...
            <div class="layo-car bor "> <!--carro -->
                <div class="ffond">
                    <img src="{{ asset('img/carros/' . $c->carro . '') }}" alt="Tipo de vehiculo" id="v"
                        alt="Carros" width="100%" height="156" usemap="#carro_8" border="0" />
                </div>
            ...
            <div class="nnno bor"> <!--final content -->
                ...
                <div class="leyenda  bor"> <!--leyenda -->
                    <p class="lll">
                        ...
                        defecto,
                        junto con otros artículos diversos, por favor no dude en ayudarnos mientras llenamos este
                        formato.
                    </p>
                    <div class="recibido cent">
                        {{-- todo ruta imagen --}}
                        <img src="{{ asset('img/firmas/' . $c->firma) }}" width="100%" height="80px" />
            ...
            <div class="fi">
                <a class="" href="#">
                    <button onclick="window.print()"><img src="{{ asset('img/imprime.jpg') }}"
                            height="50" /></button>
                </a>
            </div>
        @endforeach
