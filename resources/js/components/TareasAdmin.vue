    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify mr-2"></i> Tareass 
                <button class="btn btn-danger btn_sm float-right" type="button" @click="listarPersona2 ('1','3','status')">
                        <i class="fa fa-plus-circle mr-2"></i>Fuera de tiempo
                 </button>
                 <button class="btn btn-success btn_sm float-right" type="button" @click="listarPersona2 ('1','2','status')">
                        <i class="fa fa-plus-circle mr-2"></i>Terminadas
                 </button>
                 <button class="btn btn-primary btn_sm float-right" type="button" @click="listarPersona2 ('1','1','status')">
                        <i class="fa fa-plus-circle mr-2"></i>Nuevas
                 </button>
                 <button class="btn btn-warning btn_sm float-right" type="button" @click="listarPersona2 ('1','4','status')">
                        <i class="fa fa-plus-circle mr-2"></i>En proceso
                 </button>
                 <button class="btn btn-secondary btn_sm float-right" type="button" @click="listarPersona2 ('1','5','status')">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <template v-if="persona1.status == 1">
                            <div class="alert alert-primary" role="alert" @click="edit(persona1)">
                                {{ persona1.id }} - {{ persona1.descripcion }}
         ...
         <div class="card">
            ...
            <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="tel-seg">usuario
                            </label>
                            <div class="col-md-9">
                            <v-select
...
methods : {
    ...
    listarPersona2 (page,buscar,criterio){
        let me=this;
        var url= 'tareas/admin/?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
    ...
    cambiarPagina2(page,buscar,criterio){
        ...
        //Envia la petición para visualizar la data de esa página
        me.listarPersona2(page,buscar,criterio);
    },
    agregarTarea(id){
        let me = this;
        me.modalTarea=1;
...
selectUser(search,loading){
        let me=this;
        loading(true)
      var url = '/Zcrat/Select2/Get/Users?search=' + search + '&tarea=' + this.tareas_id;
        axios.get(url).then(function (response) {
