...
use App\Http\Controllers\zcrat\AdminCatalogosController;//restaurado
use App\Http\Controllers\zcrat\GenerarReportes;//Falta
use App\Http\Controllers\zcrat\PresuspuestosController;//restaurado desde whatsapp
use App\Http\Controllers\zcrat\VehiculosController;//Restaurado;
use App\Http\Controllers\zcrat\DetallesGeneralesController;//restaurado
use App\Http\Controllers\zcrat\OneAttributeController;//restaurado
use App\Http\Controllers\zcrat\SatController;//restaurado;
use App\Http\Controllers\zcrat\Select2Controller;//restaurado

use App\Http\Controllers\zcrat\ConceptosController;//restaurado
use App\Http\Controllers\zcrat\FacturasController;//restaurado;
use App\Http\Controllers\zcrat\HojaConceptosController;//restaurado;

use App\Http\Controllers\zcrat\MigrationDATAController;//restaurado; 
use App\Http\Controllers\zcrat\ValesAlmacenController; //restaurado
use App\Http\Controllers\zcrat\InspeccionVehicularController; //restaurado
use App\Http\Controllers\zcrat\UsuariosController;
use App\Http\Controllers\zcrat\AlmacenController;
use App\Http\Controllers\zcrat\Customers;
...
Auth::routes();
Route::get('/Zcrat/Migration/Data/CFE', [SatController::class, 'migraterecepcionesCFE'])->name('migration.data.cfe');
Route::get('/Zcrat/Migration/Data/CFB/GENERALES', [MigrationDATAController::class, 'migraterecepcionesCFBGENERALES'])->name('migration.data.cfb.generales');
Route::get('/Zcrat/Migration/Conceptos', [MigrationDATAController::class, 'index']);

Route::get('/Zcrat/Migration/Data/CFB/2025', [MigrationDATAController::class, 'migraterecepcionesCFB2025'])->name('migration.data.cfb.2025');
Route::get('/Zcrat/Migration/Data/CFB/Foraneos', [MigrationDATAController::class, 'migraterecepcionesCFBForaneos'])->name('migration.data.cfb.foraneos');
Route::get('/Zcrat/Migration/Data/ECO/2025', [MigrationDATAController::class, 'migraterecepcionesECO2025'])->name('migration.data.eco.2025');
Route::get('/Zcrat/Migration/Data/ECO/EDENRED', [MigrationDATAController::class, 'migraterecepcionesECOEDENRED'])->name('migration.data.eco.edenred');
Route::get('/Zcrat/Migration/Data/ECO/Foraneos', [MigrationDATAController::class, 'migraterecepcionesECOForaneos'])->name('migration.data.eco.foraneos');
Route::get('/Zcrat/Migration/Docs', [MigrationDATAController::class, 'MigrarDocumentos']);
Route::get('/Zcrat/Import/Conceptps/KWINTEGRA', [MigrationDATAController::class, 'ImportConceptos']);
...
Route::get('select2/obtenertiposcatalogo', 'zcrat\SelecController@select2tiposproductos')->name('select2.tiposproductoscatalogo')->middleware('auth');
Route::get('select2/obtenertiposcatalogo2', 'zcrat\SelecController@select2tiposproductos2')->name('select2.tiposproductoscatalogo2')->middleware('auth');
Route::get('select2/obtenertiposcatalogo/filter', 'zcrat\SelecController@select2todostiposproductos')->name('select2.productosallcatalogo')->middleware('auth');
Route::get('select2/obtenercategoriacatalogo', 'zcrat\SelecController@select2categoriaproductos')->name('select2.productoscategoria')->middleware('auth');
Route::get('select2/ObtenerCategoriasDisponibles', 'zcrat\SelecController@select2ObtenerCategoriasDisponibles')->name('select2.productoscategoria2')->middleware('auth');
...
Route::post('clientes/newusuario', [Customers::class,'storeOrUpdate'])->name('cliente.register');
...
Route::get('/recepcion/FAKE', 'zcrat\anio2025\cfeController@CreateRVPresupuesto')->name('cfeO2023.FAKE');
Route::middleware(['auth'])->group(function(){
        ...
        Route::post('cfe2025/update/cotizacion', 'zcrat\anio2025\cfeController@updatecotizacion')->name('2025.cfe.update.cotizacion');
        ...
        Route::post('cfe2025/pagar/pago/presupuesto', 'zcrat\anio2025\cfeController@pagarpresupuesto')->name('2025.cfe.pagar.pago.presupuesto');
        Route::post('cfe2025/cancelar/pago/presupuesto', 'zcrat\anio2025\cfeController@cancelarpago')->name('2025.cfe.cancelar.pago.presupuesto');
        Route::post('cfe2025/subir/imagenes/pago/presupuesto', 'zcrat\anio2025\cfeController@evideciaspago')->name('2025.cfe.subir.imagenes.pago.presupuesto');
        Route::delete('cfe2025/delete/imagenes/pago/presupuesto', 'zcrat\anio2025\cfeController@deleteevidenciapago')->name('2025.cfe.eliminar.imagenes.pago.presupuesto');
        Route::get('cfe2025/get/imagenes/pago/presupuesto', 'zcrat\anio2025\cfeController@getevidenciaspago')->name('2025.cfe.get.imagenes.pago.presupuesto');
        ...
        Route::post('2025/cfe/previzualizar/Facturar/varias', 'zcrat\anio2025\FacturacionController@storepreviamas')->name('2025.cfe.previsualizar.facturar.varias');
        ...
        Route::get('administracion/caja/Utilidades/view', 'zcrat\Cajacontroller@UtildadesView')->name('administracion.caja.Utilidades.view');
        ...
        Route::get('/zcrat/users', [UsuariosController::class, 'view'])->name('usuarios.vista');
        Route::get('/zcrat/users/alls', [UsuariosController::class, 'Alls'])->name('User.GetAll');
        Route::get('/zcrat/users/permisosroles', [UsuariosController::class, 'PermisosRoles'])->name('User.Get.Permisos');
        Route::post('/zcrat/users/ToggleRol', [UsuariosController::class, 'ToggleRol'])->name('User.Toggle.Rol');
        Route::post('/zcrat/users/TogglePermiso', [UsuariosController::class, 'TogglePermiso'])->name('User.Toggle.Permiso');
        Route::post('/zcrat/users/CreateOrUpdate', [UsuariosController::class, 'CreateOrUpdate'])->name('User.CreateOrUpdate');
        Route::post('/zcrat/users/Update/taller', [UsuariosController::class, 'UpdateTaller'])->name('User.Update.Taller');

        Route::post('/zcrat/generate/reporte/Salidas/Tecnicos', [GenerarReportes::class, 'TecnicosSalidas'])->name('reporte.Salidas.Tecnicos');
        Route::post('/zcrat/generate/reporte/Presupuestos', [GenerarReportes::class, 'Presupuestos'])->name('2025.Presupuestos.Exportar.Excel');
        Route::post('/zcrat/generate/reporte/PresupuestosPaginados', [GenerarReportes::class, 'PresupuestosPaginados'])->name('2025.Presupuestos.Exportar.Excel2');
        Route::post('/zcrat/generate/reporte/historial/conceptos', [GenerarReportes::class, 'ExportDataConceptosHistorial'])->name('Vehiculos.Conceptos.Historial.Exportar');
        Route::get('/zcrat/generate/reporte/seguimiento/pdf', [GenerarReportes::class, 'ReporteUnidadesSeguimientoPDF'])->name('Reporte.OrdenServicio.Seguimiento.PDF');
        
        
        
        Route::get('/RecepcionVehicular/Seguimiento/Economicos', [RecepcionVehicularController::class, 'ViewSeguimiento'])->name('2025.OrdenServicio.Seguimiento');
        Route::get('/RecepcionVehicular/Seguimiento/Read', [RecepcionVehicularController::class, 'ReadSeguimiento'])->name('2025.Recepciones.Vehiculares.Seguimineto.Elements');
        Route::post('/RecepcionVehicular/Seguimiento/Updated', [RecepcionVehicularController::class, 'UodateSeguimiento'])->name('2025.Recepciones.Vehiculares.Update.Date.Seguimiento');
        Route::post('/RecepcionVehicular/Seguimiento/taller', [RecepcionVehicularController::class, 'UodateTaller'])->name('2025.Recepciones.Vehiculares.Update.Taller');
        ...
        Route::get('/RecepcionVehicular/Get/tipoauto', [RecepcionVehicularController::class, 'obetenertipodeauto'])->name('2025.Recepcion.Vehicular.Get.tipoauto');
        ...
        Route::Post('/RecepcionVehicular/presupuesto/create', [RecepcionVehicularController::class, 'Createpresupuesto'])->name('2025.Recepcion.Vehicular.presupuesto.create');
        ...
        Route::get('/RecepcionVehicular/PDF', [RecepcionVehicularController::class, 'PDFRecepcionVehicular'])->name('2025.Recepcion.Vehicular.PDF');
        Route::get('/RecepcionVehicular/View/All', [RecepcionVehicularController::class, 'ViewAllElements'])->name('2025.Recepciones.Vehiculares.View.All.Elements');
        Route::get('/RecepcionVehicular/Get/All', [RecepcionVehicularController::class, 'GetAllElements'])->name('2025.Recepciones.Vehiculares.Get.All.Elements');
        
        Route::get('/RecepcionVehicular/Get/File/Demora', [RecepcionVehicularController::class, 'DataRetraso'])->name('Recepciones.Vehiculares.Get.Data.Demora');
        Route::delete('/RecepcionVehicular/Delete/File/Demora', [RecepcionVehicularController::class, 'DeleteFileRetraso'])->name('Recepciones.Vehiculares.Delete.File.Demora');
        Route::post('/RecepcionVehicular/Update/File/Demora', [RecepcionVehicularController::class, 'UpdateDataRetraso'])->name('Recepciones.Vehiculares.Update.Data.Demora');
        ...
        Route::get('/Zcrat/Presupuestos/Vista3', [PresuspuestosController::class, 'VistaRestringida'])->name('2025.Presupuestos.View.Restringidos');
        Route::get('/Zcrat/Presupuestos/restrin', [PresuspuestosController::class, 'GetPresupuestosRestringidos'])->name('2025.Presupuestos.Get.Elements.Restringidos');
        Route::post('/Zcrat/Presupuestos/SaveAsignacion', [PresuspuestosController::class, 'AsignarUsuario'])->name('2025.Presupuestos.Save.Asignacion');

        Route::get('/Zcrat/Presupuestos/Vista', [PresuspuestosController::class, 'VistaPresupuesto'])->name('2025.Presupuestos.View');
        Route::get('/Zcrat/Presupuestos/Vista2', [PresuspuestosController::class, 'VistaPresupuesto2'])->name('2025.Presupuestos.View2');
        Route::get('/Zcrat/Presupuestos/Consulta/Vista', [PresuspuestosController::class, 'VistaConsultaPresupuesto'])->name('2025.Presupuestos.Consulta.View');
        Route::get('/Zcrat/Presupuestos/Vista/Taller', [PresuspuestosController::class, 'VistaPresupuestotaller'])->name('2025.Presupuestos.View.Taller');
        Route::get('/Zcrat/Presupuestos/Get/Elements', [PresuspuestosController::class, 'ObtenerPresupuestos'])->name('2025.Presupuestos.Get.Elements');
        Route::get('/Zcrat/Presupuestos/Get/Utilidades', [PresuspuestosController::class, 'ObtenerUtilidadesPresupuestos'])->name('2025.Presupuestos.Get.Utilidades');
        Route::get('/Zcrat/Presupuestos/Get/Consulta/Elements', [PresuspuestosController::class, 'ObtenerConsultaPresupuestos'])->name('2025.Presupuestos.Get.Consulta.Elements');
        Route::get('/Zcrat/Presupuestos/Get/Element', [PresuspuestosController::class, 'ObtenerPresupuesto'])->name('2025.Presupuestos.Get.Element');
        Route::get('/Zcrat/Presupuestos/Get/GeneralData/Element', [PresuspuestosController::class, 'ObtenerGeneralData'])->name('2025.Presupuestos.Get.GeneralData.Element');
        Route::get('/Zcrat/Presupuestos/Get/Messages', [PresuspuestosController::class, 'Obtenermensajes'])->name('2025.Presupuestos.Get.Messages');
        Route::post('/Zcrat/Presupuestos/Create/MessagesPresupuesto', [PresuspuestosController::class, 'CreateMessagePresupuesto'])->name('2025.Presupuestos.Create.MessagesPresupuesto');
        Route::delete('/Zcrat/Presupuestos/Delete/MessagesPresupuesto', [PresuspuestosController::class, 'DeleteMessagePresupuesto'])->name('2025.Presupuestos.Delete.MessagesPresupuesto');
        Route::put('/Zcrat/Presupuestos/Change/Status', [PresuspuestosController::class, 'ChangeStatusPresupuesto'])->name('2025.Presupuestos.Change.Status');
        Route::delete('/Zcrat/Presupuestos/Delete', [PresuspuestosController::class, 'DeletePresupuesto'])->name('2025.Presupuestos.Delete');
        Route::delete('/Zcrat/Presupuestos/Delete/Restringido', [PresuspuestosController::class, 'DeletePresupuestoRestringido'])->name('2025.Presupuestos.Delete.Restringido');
        Route::put('/Zcrat/Presupuestos/Restore', [PresuspuestosController::class, 'RestaurarPresupuesto'])->name('2025.Presupuestos.Restore');
        Route::post('/Zcrat/Presupuestos/Update', [PresuspuestosController::class, 'Update'])->name('2025.Presupuestos.Update');
        Route::post('/Zcrat/Presupuestos/Create', [PresuspuestosController::class, 'Create'])->name('2025.Presupuestos.Create');
        Route::get('/Zcrat/Presupuestos/Get/CatlogoConceotos', [PresuspuestosController::class, 'CatalogoConceptos'])->name('2025.Presupuestos.Get.CatalogosConceptos');
        Route::post('/Zcrat/Presupuestos/add/Concepto', [PresuspuestosController::class, 'AgregarConceptos'])->name('2025.Presupuestos.add.Concepto');
        Route::delete('/Zcrat/Presupuestos/delete/Concepto', [PresuspuestosController::class, 'QuitarConcepto'])->name('2025.Presupuestos.Delete.Concepto');
        Route::delete('/Zcrat/Presupuestos/delete/pago', [PresuspuestosController::class, 'QuitarPago'])->name('2025.presupustos.delete.pago');
        Route::post('/Zcrat/Presupuestos/update/Concepto', [PresuspuestosController::class, 'UpdateConceptos'])->name('2025.Presupuestos.update.Conceptos');
        Route::post('/Zcrat/Presupuestos/Send/File', [PresuspuestosController::class, 'SendFile'])->name('2025.Presupuestos.Send.File');
        Route::post('/Zcrat/Presupuestos/Send/Files', [PresuspuestosController::class, 'SendFiles'])->name('2025.Presupuestos.Send.Files');
        Route::delete('/Zcrat/Presupuestos/delete/file', [PresuspuestosController::class, 'deletefile'])->name('2025.Presupuestos.delete.file');
        Route::get('/Zcrat/Presupuestos/Get/File', [PresuspuestosController::class, 'GetFile'])->name('2025.Presupuestos.Get.File');
        Route::get('/Zcrat/Presupuestos/Get/Files', [PresuspuestosController::class, 'GetFiles'])->name('2025.Presupuestos.Get.Files');
        Route::get('/Zcrat/Presupuestos/Get/Conceptos', [PresuspuestosController::class, 'GetConceptos'])->name('2025.Presupuestos.Get.Conceptos');
        Route::get('/Zcrat/Presupuestos/PDF/Costo/{id}', [PresuspuestosController::class, 'PDFCOSTO'])->name('2025.Presupuestos.PDF.Costo');
        Route::get('/Zcrat/Presupuestos/PDF/Venta/{id}', [PresuspuestosController::class, 'PDFVENTA'])->name('2025.Presupuestos.PDF.Venta');
        Route::get('/Zcrat/Presupuestos/PDF/Acuse/{id}', [PresuspuestosController::class, 'PDFACUSE'])->name('2025.Presupuestos.PDF.Acuse');
        Route::get('/Zcrat/Presupuestos/Hoja/Conceptos/{id}', [PresuspuestosController::class, 'HojaConceptos'])->name('2025.Presupuestos.Hoja.Conceptos');
        Route::get('/Zcrat/Presupuestos/Diagnostico/Tecnico/Llena/{id}', [PresuspuestosController::class, 'DiagnosticoTecnicoLLena'])->name('2025.Presupuestos.Diagnostico.Tecnico.LLena');
        Route::get('/Zcrat/Presupuestos/Diagnostico/Tecnico/{id}', [PresuspuestosController::class, 'DiagnosticoTecnico'])->name('2025.Presupuestos.Diagnostico.Tecnico');
        Route::get('/Zcrat/Presupuestos/Vista/Estatus', [PresuspuestosController::class, 'VistaPresupuestoEstatus'])->name('2025.Presupuestos.View.estatus');
        Route::get('/Zcrat/Presupuestos/Update/Pago', [PresuspuestosController::class, 'UpdatePago'])->name('2025.Presupuestos.Update.Pago');
        Route::get('/Zcrat/Presupuestos/Get/Global', [PresuspuestosController::class, 'GetGlobalVar'])->name('2025.Presupuestos.Get.Global.Variables');
        Route::get('/Zcrat/Presupuestos/Get/Pagos', [PresuspuestosController::class, 'GetPagos'])->name('2025.presupuesto.get.pagos');
        Route::get('/Zcrat/Presupuestos/Get/File/download', [PresuspuestosController::class, 'downloadFile'])->name('2025.Presupuestos.Descargar.File');
        Route::get('/Zcrat/Presupuestos/Get/files/download', [PresuspuestosController::class, 'downloadFiles'])->name('2025.Presupuestos.Descargar.Files');
        Route::post('/Zcrat/Presupuestos/Import', [PresuspuestosController::class, 'ImportPresupuestos'])->name('2025.Presupuestos.Import');
        Route::put('/Zcrat/Presupuestos/Toggle/Garantia', [PresuspuestosController::class, 'ToggleGarantia'])->name('2025.Presupuestos.Delete.Garantia');

        Route::post('/Zcrat/InspeccionVehicular/CraeteOrUpdate', [InspeccionVehicularController::class, 'createorupdate'])->name('2025.InspeccionVehicular.CreateOrUpdate');
        Route::get('/Zcrat/InspeccionVehicular/Read', [InspeccionVehicularController::class, 'Read'])->name('2025.InspeccionVehicular.Read');
        Route::get('/Zcrat/InspeccionVehicular/PDF/{id}', [InspeccionVehicularController::class, 'PDF'])->name('2025.InspeccionVehicular.PDF');
        Route::get('/Zcrat/InspeccionVehicular/PDF2', [InspeccionVehicularController::class, 'PDF2'])->name('2025.InspeccionVehicular.PDF2');

        Route::post('/Zcrat/Presupuestos/create.layaut', [PresuspuestosController::class, 'Import1Presupuestos'])->name('2025.Presupuestos.Create.Layaut');
        
        Route::post('/Zcrat/Create/Element/OneAttribute', [OneAttributeController::class, 'create'])->name('2025.Create.Element.OneAttribute');

        Route::post('/Zcrat/Facturar/Presupuesto/Unitario', [FacturasController::class, 'FacturaUnitaria'])->name('2025.Facturar.Presuspuestos.Unitario');
        Route::post('/Zcrat/Facturar/Presupuesto/Conjunto', [FacturasController::class, 'FacturaMulti'])->name('2025.Facturar.Presuspuestos.Conjunto');
        Route::post('/Zcrat/Facturar/Presupuesto/Cancelar', [FacturasController::class, 'FacturaCancelar'])->name('2025.Facturar.Cancelar.Factura');
        Route::post('/Zcrat/Facturar/Create/Prefactura', [FacturasController::class, 'PreFacturaCreate'])->name('2025.Facturar.Create.Prefactura');
        Route::get('/Zcrat/Facturar/Get/Multiples/Conceptos', [FacturasController::class, 'GetMultiplesConceptos'])->name('2025.Facturar.Get.Multiples.Conceptos');
        Route::get('/Zcrat/Facturar/Get/Prefacturas', [FacturasController::class, 'GetPrefacturas'])->name('2025.Facturar.Get.Prefacturas');
        Route::get('/Zcrat/Facturar/Get/Detalles/Prefactura', [FacturasController::class, 'GetDetallesPrefactura'])->name('2025.Facturar.Get.Detalles.Prefactura');
        Route::DELETE('/Zcrat/Facturar/Delete/Prefactura', [FacturasController::class, 'DeletePreFactura'])->name('2025.Facturar.Delete.Prefactura');
        Route::get('/Zcrat/Facturar/Get/CodigoSat', [FacturasController::class, 'GetCodigo_Sat'])->name('2025.Facturar.Get.Codigo_Sat');

        Route::get('/Zcrat/Vehiculo/Get/History', [VehiculosController::class, 'GetDataConceptosHistorial'])->name('Vehiculos.Get.Conceptos.Historial');
        Route::get('/Zcrat/Vehiculo/Get/Element', [VehiculosController::class, 'GetDataElement'])->name('2025.Vehiculos.Get.Element');
        Route::post('/Zcrat/Vehiculo/Create/Element', [VehiculosController::class, 'Create'])->name('2025.Vehiculos.Create');
        Route::post('/Zcrat/Vehiculo/Update/Element', [VehiculosController::class, 'Update'])->name('2025.Vehiculos.Update');
        
        Route::post('/Zcrat/Conceptos/Presupuestos/Create', [ConceptosController::class, 'Create'])->name('Conceptos.Presupuestos.Create');
        Route::post('/Zcrat/Conceptos/Presupuestos/Create/Global', [ConceptosController::class, 'CreateGlobal'])->name('Conceptos.Presupuestos.Create.Global');
        Route::post('/Zcrat/Conceptos/Presupuestos/Update', [ConceptosController::class, 'Update'])->name('Conceptos.Presupuestos.Update');
        Route::Delete('/Zcrat/Conceptos/Presupuestos/Delete', [ConceptosController::class, 'Delete'])->name('Conceptos.Presupuestos.Delete');
        Route::get('/Zcrat/Conceptos/Get/Element', [ConceptosController::class, 'GetDataElement'])->name('2025.Conceptos.Get.Data.Element');
        Route::get('/Zcrat/Conceptos/Get/All/Elements', [ConceptosController::class, 'GetAllElement'])->name('2025.Conceptos.Get.All.Elements');

        Route::get('/Zcrat/DetallesGenerales/Get/Element', [DetallesGeneralesController::class, 'GetElement'])->name('DetallesGenerales.Get.Element');
        Route::post('/Zcrat/DetallesGenerales/Update/Element', [DetallesGeneralesController::class, 'Update'])->name('DetallesGenerales.Update.Element');
        Route::post('/Zcrat/DetallesGenerales/Update/Exit', [DetallesGeneralesController::class, 'UpdateExit'])->name('DetallesGenerales.Update.Exit');
        Route::post('/Zcrat/DetallesGenerales/Update/Modulo', [DetallesGeneralesController::class, 'UpdateModulo'])->name('Detalles.Generales.Update.Modulo');
        Route::post('/Zcrat/DetallesGenerales/Update/Modulo/Cortana', [DetallesGeneralesController::class, 'UpdateModuloCortana'])->name('Detalles.Generales.Changer.Modulo.Cortana');
        Route::post('/Zcrat/DetallesGenerales/Register/Salida', [DetallesGeneralesController::class, 'UpdateExit'])->name('Detalles.Generales.Register.Salida');
        Route::post('/Zcrat/DetallesGenerales/Delete/Salida', [DetallesGeneralesController::class, 'DeleteExit'])->name('Detalles.Generales.Delete.Salida');
        Route::post('/Zcrat/DetallesGenerales/Register/Diagnostico', [DetallesGeneralesController::class, 'UpdateDiagnostico'])->name('Detalles.Generales.Register.Diagnostico');
        Route::post('/Zcrat/DetallesGenerales/Register/PedidoHecho', [DetallesGeneralesController::class, 'UpdatePedidoHecho'])->name('Detalles.Generales.Register.PedidoHecho');
        Route::post('/Zcrat/DetallesGenerales/Register/PedidoEntregado', [DetallesGeneralesController::class, 'UpdatePedidoEntregado'])->name('Detalles.Generales.Register.PedidoEntregado');
        Route::get('/Zcrat/DetallesGenerales/Salidas/Tecnicos', [DetallesGeneralesController::class, 'ViewTecnicosSalidas'])->name('Detalles.Generales.View.TrabajadoresSalidas');
        Route::get('/Zcrat/DetallesGenerales/Get/Elements', [DetallesGeneralesController::class, 'GetElements'])->name('DetallesGenerales.Get.Elements');
        Route::get('/Zcrat/DetallesGenerales/Salidas/Get/Elements', [DetallesGeneralesController::class, 'GetSalidasElements'])->name('DetallesGenerales.Salidas.Get.Elements');
        Route::get('/Zcrat/DetallesGenerales/EntradasYSalidas', [DetallesGeneralesController::class, 'EntradasYSalidasView'])->name('DetallesGenerales.View.EntradasYSalidas');
        Route::get('/Zcrat/DetallesGenerales/Get/Data/EntradaSalida', [DetallesGeneralesController::class, 'GetDataEntradaSalida'])->name('DetallesGenerales.Get.Data.EntradaSalida');
        Route::delete('/Zcrat/DetallesGenerales/Delete/File/Exit', [DetallesGeneralesController::class, 'DeleteArchivoSalida'])->name('DetallesGenerales.Delete.File.Exit');
        Route::get('/Zcrat/DetallesGenerales/Read/Trabajos/Parciales', [DetallesGeneralesController::class, 'ReadTrabajosParciales'])->name('DetallesGenerales.TrabajoParcial.Read');
        Route::delete('/Zcrat/DetallesGenerales/delete/Trabajos/Parciales', [DetallesGeneralesController::class, 'DeleteTrabajosParciales'])->name('DetallesGenerales.TrabajoParcial.Delete');
        Route::post('/Zcrat/DetallesGenerales/create/Trabajos/Parciales', [DetallesGeneralesController::class, 'CreateTrabajosParciales'])->name('DetallesGenerales.TrabajoParcial.Create');
        Route::post('/Zcrat/DetallesGenerales/update/Trabajos/Parciales', [DetallesGeneralesController::class, 'UpdateTrabajosParciales'])->name('DetallesGenerales.TrabajoParcial.Update');
        
        Route::get('/Zcrat/DetallesGenerales/Get/Dat/Salida', [DetallesGeneralesController::class, 'GetDataSalida'])->name('DetallesGenerales.Get.Data.Salida');
        Route::post('/Zcrat/DetallesGenerales//Reingreso/Unidad', [DetallesGeneralesController::class, 'Reingreso'])->name('Detalles.Generales.Reingreso');
        Route::post('/Zcrat/DetallesGenerales//Toggle/Subcontrato', [DetallesGeneralesController::class, 'ToggleSubcontrato'])->name('Detalles.Generales.subcontrato');

        Route::get('/Zcrat/Almacen/Inventario', [AlmacenController::class, 'InventarioVista'])->name('2025.Almacen.Inventario');
        Route::get('/Zcrat/Almacen/Movimientos', [AlmacenController::class, 'MovimientosVista'])->name('2025.Almacen.Movimientos');
        Route::get('/Zcrat/Almacen/Read/Inventario', [AlmacenController::class, 'ReadInventario'])->name('2025.Almacen.Read.Inventario');
        Route::get('/Zcrat/Almacen/Read/Movimientos', [AlmacenController::class, 'ReadMovimientos'])->name('2025.Almacen.Read.Movimientos');
        Route::post('/Zcrat/Almacen/Create/Entrada', [AlmacenController::class, 'Entrada'])->name('2025.Almacen.Create.Entrada');
        Route::post('/Zcrat/Almacen/Create/Salida', [AlmacenController::class, 'Salida'])->name('2025.Almacen.Create.Salida');
        Route::post('/Zcrat/Almacen/CrearOrEditar/Producto', [AlmacenController::class, 'CrearOrEditar'])->name('2025.Almacen.CrearOrEditar.Producto');
        Route::get('/Zcrat/Almacen/Read/Producto', [AlmacenController::class, 'ReadProducto'])->name('2025.Almacen.Read.Producto');
        Route::get('/Zcrat/Almacen/Read/Entrada', [AlmacenController::class, 'ReadEntrada'])->name('2025.Almacen.Read.Entrada');
        Route::delete('/Zcrat/Almacen/delete/Producto', [AlmacenController::class, 'DeleteProducto'])->name('2025.Almacen.Delete.Producto');
        Route::delete('/Zcrat/Almacen/delete/Movimiento', [AlmacenController::class, 'DeleteMovimiento'])->name('2025.Almacen.Delete.Movimiento');
        Route::delete('/Zcrat/Almacen/delete/Foto', [AlmacenController::class, 'DeleteFoto'])->name('2025.Almacen.Delete.Foto');



        Route::get('/Zcrat/Sat/Get/Code/Unidad', [SatController::class, 'GetCodeUnidad'])->name('Sat.Get.Code.Unidad');
        Route::get('/Zcrat/Sat/Get/Code/Sat', [SatController::class, 'GetCodeSat'])->name('Sat.Get.Code.Sat');

        Route::get('/Zcrat/Presupuestos/Get/Conceptos/HojaConceptos', [HojaConceptosController::class, 'GetElements'])->name('Presupuestos.Get.Conceptos.HojaConceptos');
        Route::post('/Zcrat/Presupuestos/UpdateOrCreate/Conceptos/HojaConceptos', [HojaConceptosController::class, 'UpdateOrCreate'])->name('Presupuestos.UpdateOrCreate.Conceptos.HojaConceptos');
        Route::post('/Zcrat/Presupuestos/create/Concepto/HojaConceptos', [HojaConceptosController::class, 'CreateElement'])->name('Presupuestos.Create.Concepto.HojaConceptos');
        Route::post('/Zcrat/Presupuestos/update/Concepto/HojaConceptos', [HojaConceptosController::class, 'UpdateElement'])->name('Presupuestos.Update.Concepto.HojaConceptos');
        Route::Delete('/Zcrat/Presupuestos/delete/Concepto/HojaConceptos', [HojaConceptosController::class, 'DeleteElement'])->name('Presupuestos.Delete.Concepto.HojaConceptos');
        Route::Delete('/Zcrat/Presupuestos/search/key/HojaConceptos', [HojaConceptosController::class, 'Search'])->name('Presupuestos.search.key.HojaConceptos');

        

        Route::get('/Zcrat/Select2/Get/Categories/Sat', [Select2Controller::class, 'GetCategoriesSat'])->name('Select2.Get.Categories.Sat');
        Route::get('/Zcrat/Select2/Get/Users', [Select2Controller::class, 'GetUser'])->name('Select2.Get.Users');
        Route::get('/Zcrat/Select2/Get/talleres', [Select2Controller::class, 'GetTalleres'])->name('Select2.Get.Talleres');
        Route::get('/Zcrat/Select2/Get/Presupuestos', [Select2Controller::class, 'GetPresupuestos'])->name('Select2.Get.Presupuestos');
        Route::get('/Zcrat/Select2/Get/Units/Sat', [Select2Controller::class, 'GetUnitsSat'])->name('Select2.Get.Units.Sat');
        Route::get('/Zcrat/Select2/Get/Categories/Concepts', [Select2Controller::class, 'GetCategoriesConcepts'])->name('Select2.Get.Categories.Concepts');
        Route::get('/Zcrat/Select2/Get/Available/Types/Concepts', [Select2Controller::class, 'GetAvailableTypesConcepts'])->name('Select2.Get.Available.Types.Concepts');
        Route::get('/Zcrat/Select2/Get/Available/Zonas', [Select2Controller::class, 'GetAvailableZonas'])->name('Select2.Get.Available.Zonas');
        Route::get('/Zcrat/Select2/Get/Available/Contratos', [Select2Controller::class, 'GetAvailableContratos'])->name('Select2.Get.Available.Contratos');
        Route::get('/Zcrat/Select2/Get/Companies', [Select2Controller::class, 'GetCompanies'])->name('Select2.Get.Companies');
        Route::get('/Zcrat/Select2/Get/Custumers', [Select2Controller::class, 'GetCustomers'])->name('Select2.Get.Customers');
        Route::get('/Zcrat/Select2/Get/Vehicles', [Select2Controller::class, 'GetVehicles'])->name('Select2.Get.Vehicles');
        Route::get('/Zcrat/Select2/Get/Vehicles/History', [Select2Controller::class, 'GetVehiclesHistory'])->name('Select2.Get.Vehicles.History');
        Route::get('/Zcrat/Select2/Get/Vehicles/History/Ordenes', [Select2Controller::class, 'GetVehiclesHistoryOrdenes'])->name('Select2.Get.Vehicles.Ordenes');
        Route::get('/Zcrat/Select2/Get/User/RepairShop', [Select2Controller::class, 'GetUserRepairShop'])->name('Select2.Get.User.RepairShop');
        Route::get('/Zcrat/Select2/Get/Available/Categories', [Select2Controller::class, 'GetAvailableCategories'])->name('Select2.Get.Available.Categories');
        Route::get('/Zcrat/Select2/Get/Modulos', [Select2Controller::class, 'GetModulos'])->name('Select2.Get.Modulos');
        Route::get('/Zcrat/Select2/Get/Zonas', [Select2Controller::class, 'GetZonas'])->name('Select2.Get.Zonas');
        Route::get('/Zcrat/Select2/Get/Contratos', [Select2Controller::class, 'GetContratos'])->name('Select2.Get.Contratos');
        Route::get('/Zcrat/Select2/Get/TiposVehiculoConceptos', [Select2Controller::class, 'GetVehiculosConceptos'])->name('Select2.Get.TiposConceptos');
        Route::get('/Zcrat/Select2/Get/ProductosProveedores', [Select2Controller::class, 'GetProductosProveedores'])->name('Select2.Get.Productos.Proveedores');
        Route::get('/Zcrat/Select2/Get/ProductosMarcas', [Select2Controller::class, 'GetProductosMarcas'])->name('Select2.Get.Productos.Marcas');
        Route::get('/Zcrat/Select2/Get/ProductosInventario', [Select2Controller::class, 'GetProductosInventario'])->name('Select2.Get.Productos.Inventarios');
        Route::get('/Zcrat/Select2/Get/OrdenesServico', [Select2Controller::class, 'GetOrdenesServico'])->name('Select2.Get.OrdenesServico');
        Route::get('/Zcrat/Select2/Get/NumeroPartesProducto', [Select2Controller::class, 'GetNumeroPartesProducto'])->name('Select2.Get.Num.Producto.Inventario');
        Route::get('/zcrat/select2/modulos/cortana', [Select2Controller::class, 'ModulosCortana'])->name('Select2.Get.Modulos.Cortana');

        Route::get('/select2/obtenerusuariosrewstringidos', [Select2Controller::class, 'GetUsuariosRestringidos'])->name('Select2.Get.Usuarios.Restringidos');
        
        Route::post('/zcrat/generate/reporte/Salidas/Tecnicos', [GenerarReportes::class, 'TecnicosSalidas'])->name('reporte.Salidas.Tecnicos');

        Route::get('/zcrat/generate/reporte/cfeeco', [GenerarReportes::class, 'export'])->name('reporte.excel.cfe.eco');
        Route::get('/zcrat/generate/reporte/cfbpg', [GenerarReportes::class, 'exportcfbpg'])->name('reporte.excel.cfb.pg');
        Route::get('/zcrat/generate/reporte/cfb2024', [GenerarReportes::class, 'exportcfb2024'])->name('reporte.excel.cfb.2024');
        Route::get('/zcrat/generate/reporte/cfbforaneos', [GenerarReportes::class, 'exportcfbforaneos'])->name('reporte.excel.cfb.foraneos');


        Route::get('/zcrat/Vales/Almacen/Read/Data', [ValesAlmacenController::class, 'GetConceptosPerVale'])->name('2025.Vales.Almacen.Read.Data');
        Route::get('/zcrat/Vales/Almacen/Read/One', [ValesAlmacenController::class, 'GetElemetsPerOrdenServicio'])->name('2025.Vales.Almacen.GetDataOne');
        Route::post('/zcrat/Vales/Almacen/Create', [ValesAlmacenController::class, 'Create'])->name('2025.Vales.Almacen.Created');
        Route::post('/zcrat/Vales/Almacen/Edit', [ValesAlmacenController::class, 'Editar'])->name('2025.Vales.Almacen.Edit');
        Route::delete('/zcrat/Vales/Almacen/Delete', [ValesAlmacenController::class, 'delete'])->name('2025.Vales.Almacen.Delete');
        Route::get('Zcrat/Vales/Almacen/pdf/{id}', [ValesAlmacenController::class, 'CreatedViewPdf'])->name('2025.Vales.Almacen.pdf');
        Route::post('Zcrat/Vales/Almacen/Entregar', [ValesAlmacenController::class, 'Entregar'])->name('2025.Vales.Almacen.Entregar');
        Route::post('Zcrat/Vales/Almacen/Surtir', [ValesAlmacenController::class, 'Surtir'])->name('2025.Vales.Almacen.Surtir');
        Route::post('Zcrat/Vales/Almacen/Autorizar', [ValesAlmacenController::class, 'AutorizarSubcontratados'])->name('2025.Vales.Almacen.Autorizar');
        Route::get('Zcrat/Vales/Almacen/Read', [ValesAlmacenController::class, 'Read'])->name('2025.Vales.Almacen.Read');
        Route::get('Zcrat/Vales/Almacen', [ValesAlmacenController::class, 'View'])->name('2025.ValesAlmacen.Gestion');
        Route::get('Zcrat/Vales/Subcontratados', [ValesAlmacenController::class, 'View2'])->name('2025.Vales2.Gestion');
        Route::get('Zcrat/Vales/Almacen/Verificar', [ValesAlmacenController::class, 'Verificar'])->name('2025.Vales.Almacen.Verificar.Entregado');

        Route::get('Zcrat/Vales/Almacen/Concentrado', [ValesAlmacenController::class, 'Concentrado'])->name('2025.Vales.Almacen.Concentrado');
        Route::get('Zcrat/Vales/Almacen/Detalles', [ValesAlmacenController::class, 'Detalles'])->name('2025.Vales.Almacen.Detalles');
        Route::post('Zcrat/Vales/Almacen/UpdateConcepto', [ValesAlmacenController::class, 'UpdateConcepto'])->name('2025.Vales.Almacen.Update.concepto');
        Route::post('Zcrat/Vales/Almacen/CreateConcepto', [ValesAlmacenController::class, 'CreateConcepto'])->name('2025.Vales.Almacen.CreateConcepto');
        Route::post('Zcrat/Vales/Almacen/EntregarConceptos', [ValesAlmacenController::class, 'EntregarConceptos'])->name('2025.Vales.Almacen.EntregarConceptos');
        Route::post('Zcrat/Vales/Almacen/CancelarEntregaConceptos', [ValesAlmacenController::class, 'CancelarEntregaConceptos'])->name('2025.Vales.Almacen.CancelarEntregaConceptos');
        Route::post('Zcrat/Vales/Almacen/UpdateConcepto', [ValesAlmacenController::class, 'UpdateConcepto'])->name('2025.Vales.Almacen.UpdateConcepto');
        Route::post('Zcrat/Vales/Almacen/DeleteConcepto', [ValesAlmacenController::class, 'DeleteConcepto'])->name('2025.Vales.Almacen.DeleteConcepto');
...
->middleware('permission:ordenes.index'); 
    ...
    //DetalleConceptos
Route::get('/detalleCarritoAF', 'AFCarritoController@index')->name('cfbForaneos.index')->middleware('permission:cfbForaneos.index');     
