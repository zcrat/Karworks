...
class Customers extends Controller
{
    ...
    public function storeOrUpdate(Request $request)
    {
        $request->validate([
            ...
            'customer-idempresa' => ['required', 'exists:empresas,id'],
            'customer-usuario' => ['required', 'string'],
            'customer-direccion' => ['required', 'string'],
            'customer-ciudad' => ['required', 'string'],
            'customer-estado' => ['required', 'string'],
            'customer-cp' => ['required', 'string'],
            'customer-tel_casa' => ['required', 'string'],
            'customer-tel_oficina' => ['required', 'string'],
            'customer-tel_celular' => ['required', 'string'],
        ...
        try {
            ...
            $customer->save();
            DB::commit();
            return response()->json(['message'=> $estatus]);
        } catch (\Exception $e) {
            DB::rollBack();
