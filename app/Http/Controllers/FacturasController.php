...
class FacturasController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      if($criterio!='empresas.nombre' && $buscar!=''){
            if($criterio=='num_comprobante'){
                $criterio='folio_fact';
            }
            $facturas = $facturas->filter(function ($factura) use ($criterio, $buscar) {
                return Str::contains(strtolower(data_get($factura, $criterio)), strtolower($buscar));
            });
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $keypem->generaKeyPemZcrat($archivo_key,$factura_emisor->clave_key);
